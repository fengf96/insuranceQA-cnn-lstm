...
class InsQACNN(object):
    def __init__(
        ...
        with tf.variable_scope("mycnn") as s:
            pooled_outputs_1 = mycnn(self.embedded_chars_expanded_1)
            s.reuse_variables()
            pooled_outputs_2 = mycnn(self.embedded_chars_expanded_2)
            pooled_outputs_3 = mycnn(self.embedded_chars_expanded_3)
